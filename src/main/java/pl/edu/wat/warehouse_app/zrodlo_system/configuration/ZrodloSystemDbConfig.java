...
public class ZrodloSystemDbConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(EntityManagerFactoryBuilder pBuilder, @Qualifier("zrodloSystemDataSource") DataSource pDataSource) {
